/**
   @file CircuitInfo.cpp
   @brief This program parses one or more VPR benchmark files and outputs summary info.
...
struct Parameters {
    ...
    void validate() const {
        if(benchmark_paths.size() == 0) {
            throw po::validation_error(po::validation_error::invalid_option_value, "No benchmark file specified.");
        } else {
